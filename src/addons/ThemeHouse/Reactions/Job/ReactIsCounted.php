...
class ReactIsCounted extends AbstractRebuildJob
{
    ...
    protected function rebuildById($id)
    {
        ...
        $this->app->repository('ThemeHouse\Reactions:ReactedContent')->recalculateReactIsCounted($reactedContent->content_type, $reactedContent);
    }
